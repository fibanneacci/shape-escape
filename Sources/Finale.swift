...
public class Finale: SKScene {
    ...
    public func grid(r: Int, c: Int) { //generalize from 5x5 to all sizes
        ...
        let trianglePlayer = SKSpriteNode(imageNamed: "plane.png")
        ...
        let circlePlayer = SKSpriteNode(imageNamed: "wwdc.png")
    ...
    public override func didMove(to view: SKView) {
        ...
        label1.text = "This is the most difficult and most important challenge."
        ...
        label1line2.text = "Can the developer who created this playground"
        ...
        label1line3.text = "win a scholarship to WWDC19? 😬"
        ...
        planePencil.setScale(0.5)
        planePencil.position = CGPoint(x: self.frame.midX + 96.0, y: 0)
        planePencil.name = "planePencil"
        pencilNum = -1
    ...
    public func touchDown(atPoint pos : CGPoint) {
        ...
        if (name == "backButton" || name == "backLabel") {
            ...
            if (pencilNum == 4) {
                ...
                greenPencil.position = CGPoint(x: self.frame.midX, y: 0)
                grayPencil.position = CGPoint(x: self.frame.midX + 48.0, y: 0)
                planePencil.position = CGPoint(x: self.frame.midX + 96.0, y: 60)
                pencilNum = 4
            }
                ...
                case 4:
                    if (current.rowNum == len - 1 && current.colNum == wid - 1) {
                        if (connectivity[current.rowNum][current.colNum]) {
                            ...
                            insLabel.text = "Yay, it seems like the answer is yes! 🎉"
                    ...
                    if (connectivity[current.rowNum][current.colNum]) {
                        ...
                        insLabel.text = "Will she make it?"
                        childNode(withName: "trianglePlayer")!.position = gridUnitWithName(name: name!)!.position
                    } else {
                        insLabel.fontColor = SKColor.red
